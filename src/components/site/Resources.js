    ...
    <div className='main'>
      <div className='mainDiv'>
        ...
        <ul>
          ...
          <li>
            <a href='https://reacttraing.com/react-router' target='_blank'>
              React Router Dom
            </a>
          </li>
          <li>
          ...
          <li>
            <a
              ...
              target='_blank'>
              Samer Buna's Pluralsight Course for the GitHub API
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            <a href='https://www.reactstrap.github.io/' target='_blank'>
