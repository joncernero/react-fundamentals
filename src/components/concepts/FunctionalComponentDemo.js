        ...
        <Col xs='12'>
          ...
          <dl>
            ...
            <dd>
              ...
              render a display to the page and update to the information to be
              shown
            </dd>
            <dt>No 'this' keyword</dt>
            <dd>
              Older class components use 'this', functional components have not
              'this' object
            </dd>
